...
trigonometric.sin = function (x) {
	...
	if (lo_quadrant == hi_quadrant) {
		if (x.hi - x.lo > constants.PI_LOW) { return whole_range }
		...
		return Interval(rmath.sinLo(x.hi), rmath.sinHi(x.hi))
	}
...
trigonometric.tan = function (x) {
	...
	else { return division.nonZero(
			trigonometric.sin(x),trigonometric.cos(x))
	}
}
