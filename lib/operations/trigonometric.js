...
/**
 * Returns the sine function of an interval x.
 * @param {Interval} x
 * @returns {Interval}
 */
...
/**
 * Returns the cosine function of an interval x.
 * Based on the identity cos(x) = sin(x + pi/2)
 * @param {Interval} x
 * @returns {Interval}
 */
...
/**
 * Returns the tangent function of an interval x.
 * Based on the definition of the tan(x) = sin(x)/cos(x)
 * @param {Interval} x
 * @returns {Interval}
 */
...
/**
 * Returns the cotangent function of an interval x.
 * Based on the definition of the cot(x) = 1/tan(x)
 * @param {Interval} x
 * @returns {Interval}
 */
...
/**
 * Returns the inverse sine function of an interval x.
 * @param {Interval} x
 * @returns {Interval}
 */
...
/**
 * Returns the inverse cosine function of an interval x.
 * @param {Interval} x
 * @returns {Interval}
 */
...
/**
 * Returns the inverse tangent function of an interval x.
 * @param {Interval} x
 * @returns {Interval}
 */
...
/**
 * Returns the hyperbolic sine function of an interval x.
 * @param {Interval} x
 * @returns {Interval}
 */
...
/**
 * Returns the hyperbolic cosine function of an interval x.
 * @param {Interval} x
 * @returns {Interval}
 */
...
/**
 * Returns the hyperbolic tangent function of an interval x.
 * @param {Interval} x
 * @returns {Interval}
 */
