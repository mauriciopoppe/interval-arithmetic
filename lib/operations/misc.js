...
misc.setIntersection = function intersection_destructive(a, b) {
		  var result = [];
...
// Creating a python like range function that returns an array
misc.range = function range(start, stop, step) {
